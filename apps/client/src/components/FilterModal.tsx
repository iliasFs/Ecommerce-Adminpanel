...
const FilterModal: React.FC<filterProps> = ({
  ...
  return (
    <div className="flex p-4 flex-col items-center">
      <div className="w-full min-h-[51px] mb-5 flex justify-center ">
        <h1 className="font-bold text-lg category-heading">{`T-SHIRTS FOR ${type.toUpperCase()}`}</h1>
      </div>
      <div className="min-w-[360px] xl:min-w-[260px] mb-7  justify-center items-center xl:relative  border-2 rounded border-[#1D3557] ">
