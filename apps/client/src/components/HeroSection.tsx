  ...
  return (
    <div className="flex section__margin items-center w-full h-[calc(100vh-168px)] ">
      <div className="relative w-full bg-[#1D3557] h-[73%] overflow-hidden ">
        <div className="hidden sm:flex main-letters-1 absolute h-[294px] leading-[293.5px] tracking-[-30px] top-[-64px] left-[490px] font-extrabold">
          <h1 className="whitespace-nowrap text-[450px] border-text ">
            Tees to
          </h1>
        </div>
        <div className="hidden sm:flex main-letters-2 absolute leading-[293.5px] tracking-[-30px] top-[275px] left-[578px] font-extrabold">
          <h1 className="text-[450px] border-text ">bliss</h1>
        </div>
        <div className="absolute hidden sm:flex top-[10px] w-[291px] h-[120px] left-[620px] ">
